...
class AppColors {
  static const warmYellow = Color(0xFFF1C6A0);
  static const sandBeige = Color(0xFFE8D5D2);
  static const vividOrange = Color(0xFFD89A80);
  static const earthBrown = Color(0xFF9CADCE);
  static const golden = Color(0xFFD8B45F);
  static const clay = Color(0xFFA88F89);
  static const softRose = Color(0xFFE8B4B8);
  static const taupe = Color(0xFFC9ADA7);
  static const serenityBlue = Color(0xFF9CADCE);
  static const lavender = Color(0xFFB4A7D6);
